...
// Configuration to connect to the postgres database on - ockam:15432
//
// ockam:15432 is the inlet address of the tcp portal to postgres.
// This inlet is local to analysis_corp, the postgres database is remote in bank_corp.
const clientConfig = { host: "ockam", port: 15432, user: "postgres", password: "postgres", database: "test" };
